...
#' post_logreg_individual(X,Y.hat,lambda,beta_hat,level.alpha = 0.10)
#' @export
...
#' }
#'
#' beta_hat <- EM_group(X=X, Z=Z, Se=0.95, Sp=0.95, lambda=5, tol=1e-3)$beta_hat
#' Y.hat <- EM_group(X=X, Z=Z, Se=0.95, Sp=0.95, lambda=5, tol=1e-3)$Y.hat
